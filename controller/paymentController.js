    ...
    try {
        ...
        const response = await axios.post(
            "https://kapi.kakao.com/v1/payment/ready",
            {
                ...
                total_amount,
                tax_free_amount: 0,
                approval_url: "http://casetibuy-project.s3-website.ap-northeast-2.amazonaws.com/order-success",
                cancel_url: "http://casetibuy-project.s3-website.ap-northeast-2.amazonaws.com/payment/cancel",
                fail_url: "http://casetibuy-project.s3-website.ap-northeast-2.amazonaws.com/payment/fail",
            },
            {
                headers: {
